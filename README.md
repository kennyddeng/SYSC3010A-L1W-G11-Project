...
1. To record and push temperature data, navigate to [firebase_v2.py](/firebase_v2.py) as well as [local_SQL.py](https://github.com/kennyddeng/SYSC3010A-L1W-G11-Project/blob/main/write/local_SQL.py) and run the script.
